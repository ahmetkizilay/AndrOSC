 ...
 */
public class OSCVSliderSettingsWrapper extends OSCControlSettingsWrapper {
    ...
    public OSCVSliderSettingsWrapper(OSCVerticalSliderView control) {
        super(control);
    }

    @Override
    public void setup(ViewGroup container, HSLColorPicker colorPicker) {
        OSCVerticalSliderView thisControl = (OSCVerticalSliderView) super.mControl;
